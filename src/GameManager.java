...
public class GameManager {
        ...
        if (!currentRoom.hasVisited()) {
            ...
            switch (event) {
                ...
                case 4: case 5: case 6: case 7: case 8: case 9: case 10:
                    ...
                    int enemy = enemy_selection;
                    switch (enemy) {
                        case 20: case 19: case 18: case 17: case 16: case 15: case 14: case 13: case 12: case 11: case 10:
    ...
    private void combat(Enemy enemy) {
        ...
        if (player.isDead()) {
            ...
            player.gainExperience(enemy.getXpGiven());
        }
        if (enemy.getName() == "Wyvern") {
            wyvernSlain = true;
        }
